...
const Footer = () => {
  return (
    ...
    <div className='left-up-footer'>
        <h3>People are Saying About Do White</h3>
...
<path d="M35 0H45L38 38H23.5L35 0Z" fill="#D9D9D9"/>
        ...
        <div className=" image-person" >
            <img src={"https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8bWFufGVufDB8fDB8fHww "}/>
            <img src={"https://images.unsplash.com/photo-1596075780750-81249df16d19?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D "}/>
            ...
            <img src={" https://images.unsplash.com/photo-1541260894924-7ff059b93d54?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}/>
            <svg className='svgg' width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M42 33L28.5 43.3923L28.5 22.6077L42 33Z" fill="white"/>
   ...
   <h4>Get Started</h4>
    ...
    <button id='requestdemo'>Request Demo</button>
     <p id='freetrial'>or Start Free Trial</p>
    </form>
    ...
    <div className='div-4'>
      ...
      <div className='lower-footer-input'> <input type='text ' placeholder='Enter your email here'></input><div className='circle-arrow'><p>-&gt;</p></div>
      {/* <svg  className='svgg' width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M12 5L19 12L12 19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div className='credit'>
      <div className='copyright'><p>© 2022 Biccas Inc. Copyright and rights reserved</p></div>
      <div className='termandpoli'><p>Terms and Condtions</p> || <p>Privacy Policy</p></div>
    </div>
